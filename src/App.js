...
export default function App() {
  ...
  async function handleSubmit(e) {
    ...
    formData.append("entry.1789557843", active); // Venue
        ...
        <div style={{ maxWidth: 980, margin: "0 auto" }}>
          ...
          <main
            style={{
              ...
              borderRadius: 16,
              padding: 18,
              boxShadow: "0 10px 30px rgba(11,79,155,0.06)",
            }}
          >
            <div
              style={{
              ...
              <section>
                ...
                <div style={{ marginTop: 12 }}>
                  <h2 style={{ margin: 0, color: "#071023" }}>
                    {activeEvent.title} —{" "}
                    <span style={{ color: "#0b4f9b" }}>
                      {activeEvent.rate}
                    </span>
                  </h2>
                  <p style={{ marginTop: 6, color: "#071023" }}>
                    Capacity: {activeEvent.maxCapacity} people — Minimum booking
                    duration: 1 week
                  </p>
                  <p style={{ marginTop: 6, color: "#071023" }}>
                    Choose your activity type and preferred date/time on the
                    right to submit a booking.
                  </p>
                </div>
              </section>
                ...
                >
                  ...
                  <label style={{ color: "#071023", fontSize: 13 }}>
                    ...
                    <input
                      ...
                      placeholder="e.g., Birthday, Corporate, Photoshoot"
                    />
                  </label>
                    ...
                    <div style={{ color: "#071023" }}>
                      ...
                      >
                        <input
                          ...
                          name="areaRequested"
                          value="Restaurant"
                          checked={form.areaRequested === "Restaurant"}
                          onChange={handleChange}
                          required
                        />{" "}
                        Restaurant
                      ...
                      >
                        <input
                          ...
                          name="areaRequested"
                          value="Pool"
                          checked={form.areaRequested === "Pool"}
                          onChange={handleChange}
                        />{" "}
                        Pool
                      </label>
                      ...
                      >
                        <input
                          ...
                          name="areaRequested"
                          value="Both"
                          checked={form.areaRequested === "Both"}
                          onChange={handleChange}
                        />{" "}
                        Both
                      </label>
                  ...
                  <label style={{ color: "#071023", fontSize: 13 }}>
                    ...
                    <input
                      ...
                      placeholder={`Max ${activeEvent.maxCapacity}`}
                    />
                  </label>
                  ...
                  <div style={{ display: "flex", gap: 8, marginTop: 6 }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 10,
                        background: "#fff",
                        border: "1px solid rgba(11,79,155,0.12)",
                        cursor: "pointer",
                      }}
                    >
                      Reset
                  ...
                  <div style={{ marginTop: 10, fontSize: 12, color: "#334155" }}>
                    <strong>You will love it here!!!</strong>{" "}
